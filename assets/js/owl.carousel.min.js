...
!(function (a, b, c, d) {
  ...
  (e.Defaults = {
    ...
    if (
      (b.wrap (a ('<div/>', {class: 'owl-video-wrapper', style: g})), this._core
    ...
    this._playing ||
      ...
      )), c.attr ('height', h), c.attr ('width', g), 'youtube' === f.type
        ? c.attr (
            'src',
  ...
  (e.Defaults = {
    ...
    this._core.is ('rotating') &&
      !this._paused &&
      ((this._time = this.read ()), (this._paused = !0), b.clearTimeout (
        this._call
      ));
  }), (e.prototype.destroy = function () {
    var a, b;
